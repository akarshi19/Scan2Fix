...
export default function ManageUsers() {
  ...
  // ✅ FIXED: Toggle availability with proper state update
  ...
  const renderUser = ({ item }) => (
    <TouchableOpacity 
      style={[
        styles.card,
        item.is_on_leave && styles.cardOnLeave
      ]}
    ...
    >
      <View style={styles.cardContent}>
        ...
        <View style={styles.userInfo}>
          ...
          {item.designation && (
            <Text style={styles.designation}>{item.designation} Staff</Text>
          )}
        </View>
      ...
      {item.role === 'STAFF' && (
        <View style={styles.quickActions}>
          <TouchableOpacity 
            style={[
              styles.actionButton,
              item.is_on_leave ? styles.actionButtonAvailable : styles.actionButtonLeave
            ]}
            onPress={() => toggleAvailability(item.id, item.is_on_leave, item.full_name || item.email)}
          >
            <Text style={[
              styles.actionButtonText,
              item.is_on_leave ? styles.actionButtonTextAvailable : styles.actionButtonTextLeave
            ]}>
