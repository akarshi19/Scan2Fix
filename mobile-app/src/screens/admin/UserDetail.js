...
export default function UserDetail({ route, navigation }) {
  ...
  const toggleLeaveStatus = async () => {
    ...
    try {
      ...
      Alert.alert('Success', `User is now ${newStatus ? 'on leave' : 'available'}`);
    } catch (error) {
      ...
      <View style={styles.header}>
        ...
        {user.is_on_leave && (
          <View style={styles.leaveBadge}>
            <Text style={styles.leaveBadgeText}>🏠 Currently On Leave</Text>
          </View>
        )}
      </View>
            ...
            {user.role === 'STAFF' && (
              <>
                <View style={styles.detailRow}>
                  ...
                  <Text style={styles.detailValue}>{user.employee_id || 'Not provided'}</Text>
                </View>
                <View style={styles.detailRow}>
                  <Text style={styles.detailLabel}>💼 Designation:</Text>
                  <Text style={styles.detailValue}>{user.designation || 'Not set'}</Text>
                </View>
              </>
            )}
            <View style={styles.detailRow}>
      ...
      {user.role === 'STAFF' && (
        <View style={styles.card}>
          ...
          <Button
            ...
            icon={user.is_on_leave ? 'check' : 'home'}
          >
